...
export async function getCreditInfo() {
  return apiRequest('/users/credit')
}
...
export async function requestCreditPurchase(purchaseData) {
  return apiRequest('/users/credit/purchase', {
    method: 'POST',
...
export async function getCreditPurchases(params = {}) {
  const queryParams = new URLSearchParams(params).toString()
  return apiRequest(`/users/credit/purchases?${queryParams}`)
}

/**
 * Get Credit Purchase Details
 * GET /users/credit/purchases/:requestId
 * 
...
export async function getCreditPurchaseDetails(requestId) {
  return apiRequest(`/users/credit/purchases/${requestId}`)
}
...
export async function getCreditHistory(params = {}) {
  const queryParams = new URLSearchParams(params).toString()
  return apiRequest(`/users/credit/history?${queryParams}`)
}

/**
 * Create Repayment Payment Intent
 * POST /users/credit/repayment/create-intent
 */
export async function createRepaymentIntent(repaymentData) {
  return apiRequest('/users/credit/repayment/create-intent', {
    method: 'POST',
...
/**
 * Confirm Repayment
 * POST /users/credit/repayment/confirm
 */
export async function confirmRepayment(confirmationData) {
  return apiRequest('/users/credit/repayment/confirm', {
    method: 'POST',
 ...
 * GET /users/credit/repayment/history
 */
export async function getRepaymentHistory(params = {}) {
  const queryParams = new URLSearchParams(params).toString()
  return apiRequest(`/users/credit/repayment/history?${queryParams}`)
}

/**
 * Get Repayment Rules (Tiers)
 * GET /users/credit/repayment/rules
 */
export async function getRepaymentRules() {
  return apiRequest('/users/credit/repayment/rules')
}
 ...
 * GET /users/credit/purchases/pending
 * 
 * @returns {Promise<Object>} - { purchases: Array }
 */
export async function getPendingPurchases() {
  return apiRequest('/users/credit/purchases/pending')
}

/**
 * Calculate Repayment Amount
 * POST /users/credit/repayment/calculate
 * 
...
export async function calculateRepaymentAmount(data) {
  return apiRequest('/users/credit/repayment/calculate', {
    method: 'POST',
    body: JSON.stringify(data),
  })
}
 ...
 * GET /users/credit/repayment/:purchaseId/projection
 * 
...
export async function getRepaymentProjection(purchaseId) {
  return apiRequest(`/users/credit/repayment/${purchaseId}/projection`)
}

/**
 * Initiate Repayment (Online/Razorpay)
 * POST /users/credit/repayment/:purchaseId/initiate
 */
export async function initiateRepayment(purchaseId, data = {}) {
  let url = `/users/credit/repayment/${purchaseId}/initiate`
  if (data.amount) {
    url += `?amount=${data.amount}`
  }

  console.log('🔍 [userApi.initiateRepayment] URL:', url)
  console.log('🔍 [userApi.initiateRepayment] Data:', data)
  console.log('🔍 [userApi.initiateRepayment] Body:', JSON.stringify(data))
 ...
 * POST /users/credit/repayment/:purchaseId/verify
 */
export async function verifyRepayment(purchaseId, data) {
  return apiRequest(`/users/credit/repayment/${purchaseId}/verify`, {
    method: 'POST',
    body: JSON.stringify(data),
  })
}
 ...
 * POST /users/credit/repayment/:purchaseId/submit
 * 
 * @param {string} purchaseId - Purchase ID
...
export async function submitRepayment(purchaseId, data) {
  return apiRequest(`/users/credit/repayment/${purchaseId}/submit`, {
    method: 'POST',
    body: JSON.stringify(data),
  })
}
...
export async function getCreditNotifications() {
  return apiRequest('/users/notifications?type=repayment_due_reminder,repayment_overdue_alert,admin_announcement')
}
